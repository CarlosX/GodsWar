...
namespace LoginServer.Networking
{
    public static class PacketManager
    {
        ...
        public static bool TryPeek(this ConcurrentQueue<LoginPacket> queue, out LoginPacket result, PacketFilter filter)
        {
            result = null;
    ...
    {
        protected PacketFilter(LoginSession pSession)
        {
            m_pSession = pSession;
        }

        public abstract bool Process(LoginPacket packet);

        public virtual bool ProcessUnsafe() { return false; }

        protected LoginSession m_pSession;
    }

    public class LoginSessionFilter : PacketFilter
    {
        public LoginSessionFilter(LoginSession pSession) : base(pSession) { }

        public override bool Process(LoginPacket packet)
        {
